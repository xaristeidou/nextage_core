...
public:
  // IDL operations
  ::CORBA::Double setPosition(::statusPluginTypes::kindType kind, const ::statusPluginTypes::JointValues& position, ::CORBA::Double minimumTime, ::CORBA::Double percent, ::commonStatus::statSequence_out status);
  ::CORBA::Double setJointAngles(::statusPluginTypes::kindType kind, const ::jointAnglePluginTypes::Nums& jointNums, const ::statusPluginTypes::JointValues& jointAngles, ::CORBA::Double minimumTime, ::CORBA::Double percent, ::commonStatus::statSequence_out status);
...
public:
  ...
  virtual ::CORBA::Double setPosition(::statusPluginTypes::kindType kind, const ::statusPluginTypes::JointValues& position, ::CORBA::Double minimumTime, ::CORBA::Double percent, ::commonStatus::statSequence_out status) = 0;
  virtual ::CORBA::Double setJointAngles(::statusPluginTypes::kindType kind, const ::jointAnglePluginTypes::Nums& jointNums, const ::statusPluginTypes::JointValues& jointAngles, ::CORBA::Double minimumTime, ::CORBA::Double percent, ::commonStatus::statSequence_out status) = 0;
