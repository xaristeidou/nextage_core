...
public:
  // IDL operations
  ::CORBA::Boolean inMotionJoint(::statusPluginTypes::jointType& joint, ::statusPluginTypes::kindType wait, ::commonStatus::statSequence_out status);
  ::CORBA::Boolean inMotionPart(::statusPluginTypes::partType& part, ::statusPluginTypes::kindType wait, ::commonStatus::statSequence_out status);
  ::CORBA::Boolean getJointValue(::CORBA::Octet startJoint, ::CORBA::Octet jointNum, ::statusPluginTypes::kindType outKind, ::statusPluginTypes::JointValues_out joint_values, ::commonStatus::statSequence_out status);
  ::CORBA::Boolean getPositionArm(::statusPluginTypes::kindType outKind, ::statusPluginTypes::JointValues_out joint_values, ::commonStatus::statSequence_out status);
  ::CORBA::Boolean getChangeMcName(::CORBA::Octet jointNum, ::CORBA::Double& mcID, ::CORBA::String_out name, ::commonStatus::statSequence_out status);
  ::CORBA::Boolean convertData(const ::statusPluginTypes::JointValues& inValues, const ::statusPluginTypes::JointValues& handOffset, ::statusPluginTypes::kindType inKind, ::statusPluginTypes::kindType outKind, ::statusPluginTypes::JointValues_out outValues, ::commonStatus::statSequence_out status);
  ::CORBA::Boolean setHandOffset(const ::statusPluginTypes::JointValues& handOffset, ::statusPluginTypes::kindType inKind, ::commonStatus::statSequence_out status);
  ::CORBA::Boolean getHandOffset(::statusPluginTypes::kindType outKind, ::statusPluginTypes::JointValues_out handOffset, ::commonStatus::statSequence_out status);
  void getStatus(::statusPluginTypes::RobotStatus_out robotStatuses);
  void getInterrupt(::statusPluginTypes::partType& part);
  ::CORBA::Double getChestTarget();
  ::CORBA::Double getDeltaT();
  ::CORBA::Boolean SetSafetyPercent(::CORBA::Double SafePercent);
  void InitSafetyPercent();
...
public:
  ...
  virtual ::CORBA::Boolean inMotionJoint(::statusPluginTypes::jointType& joint, ::statusPluginTypes::kindType wait, ::commonStatus::statSequence_out status) = 0;
  virtual ::CORBA::Boolean inMotionPart(::statusPluginTypes::partType& part, ::statusPluginTypes::kindType wait, ::commonStatus::statSequence_out status) = 0;
  virtual ::CORBA::Boolean getJointValue(::CORBA::Octet startJoint, ::CORBA::Octet jointNum, ::statusPluginTypes::kindType outKind, ::statusPluginTypes::JointValues_out joint_values, ::commonStatus::statSequence_out status) = 0;
  virtual ::CORBA::Boolean getPositionArm(::statusPluginTypes::kindType outKind, ::statusPluginTypes::JointValues_out joint_values, ::commonStatus::statSequence_out status) = 0;
  virtual ::CORBA::Boolean getChangeMcName(::CORBA::Octet jointNum, ::CORBA::Double& mcID, ::CORBA::String_out name, ::commonStatus::statSequence_out status) = 0;
  virtual ::CORBA::Boolean convertData(const ::statusPluginTypes::JointValues& inValues, const ::statusPluginTypes::JointValues& handOffset, ::statusPluginTypes::kindType inKind, ::statusPluginTypes::kindType outKind, ::statusPluginTypes::JointValues_out outValues, ::commonStatus::statSequence_out status) = 0;
  virtual ::CORBA::Boolean setHandOffset(const ::statusPluginTypes::JointValues& handOffset, ::statusPluginTypes::kindType inKind, ::commonStatus::statSequence_out status) = 0;
  virtual ::CORBA::Boolean getHandOffset(::statusPluginTypes::kindType outKind, ::statusPluginTypes::JointValues_out handOffset, ::commonStatus::statSequence_out status) = 0;
  virtual void getStatus(::statusPluginTypes::RobotStatus_out robotStatuses) = 0;
  virtual void getInterrupt(::statusPluginTypes::partType& part) = 0;
  virtual ::CORBA::Double getChestTarget() = 0;
  virtual ::CORBA::Double getDeltaT() = 0;
  virtual ::CORBA::Boolean SetSafetyPercent(::CORBA::Double SafePercent) = 0;
  virtual void InitSafetyPercent() = 0;
